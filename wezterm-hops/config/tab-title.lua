...
M.set_title = function(index, process_name, base_title, max_width, inset)
   local title
   inset = inset or 6
...
M.setup = function()
   wezterm.on("format-tab-title", function(tab, tabs, panes, config, hover, max_width)
      ...
      local title = M.set_title(index, process_name, tab.active_pane.title, max_width, (is_admin and 8))
